...
public class PrimerParcialController extends AbstractController implements Serializable {
    ...
    public void guardar() {
        if (!actividadFacade.listaActividades(Fecha.getDate(), Funcionalidad.REGISTRO_NOTAS_PRIMER_PARCIAL, seleccionGestionAcademica.getId_gestionacademica(), seleccionCarrera.getId_carrera()).isEmpty()) {
