 ...
 * @author tincho
 */
@WebServlet(name = "FichaEvaluacionTutor", urlPatterns = {"/reportes/pasantias/fichaEvaluacionEmpresa/FichaEvaluacionTutor"})
public class FichaEvaluacionTutor extends HttpServlet {
    ...
    public PdfPTable titulo(NotaPasantia notaPasantia) throws BadElementException, IOException {
        ...
        cell = new PdfPCell(new Phrase("FICHA DE EVALUACIÓN TUTOR", TITULO));
        cell.setHorizontalAlignment(PdfPCell.ALIGN_LEFT);
        cell.setVerticalAlignment(PdfPCell.ALIGN_MIDDLE);
        cell.setColspan(80);
        cell.setRowspan(2);
    ...
    public PdfPTable contenido(NotaPasantia notaPasantia) throws BadElementException, IOException {
        ...
        cell = new PdfPCell(new Phrase(String.valueOf(notaPasantia.getNotaTutor()), NORMAL));
        cell.setHorizontalAlignment(PdfPCell.ALIGN_CENTER);
        cell.setVerticalAlignment(PdfPCell.ALIGN_MIDDLE);
        cell.setColspan(25);
        table.addCell(cell);

        cell = new PdfPCell(new Phrase(String.valueOf(notaPasantia.getNotaFinal()), NORMAL));
        cell.setHorizontalAlignment(PdfPCell.ALIGN_CENTER);
        cell.setVerticalAlignment(PdfPCell.ALIGN_MIDDLE);
        cell.setColspan(25);
        table.addCell(cell);

        cell = new PdfPCell(new Phrase(notaPasantia.getCondicion().toString(), NORMAL));
        cell.setHorizontalAlignment(PdfPCell.ALIGN_CENTER);
        cell.setVerticalAlignment(PdfPCell.ALIGN_MIDDLE);
        cell.setColspan(25);
        table.addCell(cell);
