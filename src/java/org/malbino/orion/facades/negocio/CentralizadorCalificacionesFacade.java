...
public class CentralizadorCalificacionesFacade {
    ...
    @Transactional(Transactional.TxType.REQUIRED)
    public List<Estudiante> listaEstudiantesRecuperatorio(int id_gestioncademica, int id_carrera, Nivel nivel, Turno turno, String paralelo) {
        List<Estudiante> l = new ArrayList();
        ...
        for (Nivel nivel : niveles) { //niveles
            ...
            for (Turno turno : turnos) { //turnos
                ...
                for (String paralelo : paralelos) { //paralelos
                    ...
                    List<Estudiante> estudiantes = listaEstudiantes(gestionAcademica.getId_gestionacademica(), carrera.getId_carrera(), nivel, turno, paralelo);
                    ...
                    if (!estudiantes.isEmpty()) {
                        ...
                        //notas
                        List<Nota> notas = listaNotas(gestionAcademica.getId_gestionacademica(), carrera.getId_carrera(), nivel, turno, paralelo);
