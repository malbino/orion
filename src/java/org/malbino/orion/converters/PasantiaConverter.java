 ...
 * @author malbino
 */
@Named(value = "PasantiaConverter")
@RequestScoped
public class PasantiaConverter implements Converter {

    @EJB
    PasantiaFacade materiaFacade;
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object value) {
        ...
        if (value == null || value.equals("")) {
            ...
            s = String.valueOf(((Pasantia) value).getId_pasantia());
        }
